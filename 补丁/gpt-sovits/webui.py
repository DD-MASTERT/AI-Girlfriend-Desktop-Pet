...
with gr.Blocks(title="GPT-SoVITS WebUI") as app: 
    ...
    with gr.Tabs():
        with gr.TabItem(i18n("0-前置数据集获取工具")):#提前随机切片防止uvr5爆内存->uvr5->slicer->asr->打标
            ...
            open_asr_button.click(open_asr, [asr_inp_dir, asr_opt_dir, asr_model, asr_size, asr_lang], [asr_info,open_asr_button,close_asr_button], concurrency_limit=511)
            close_asr_button.click(close_asr, [], [asr_info,open_asr_button,close_asr_button], concurrency_limit=511)
            open_slicer_button.click(open_slice, [slice_inp_path,slice_opt_root,threshold,min_length,min_interval,hop_size,max_sil_kept,_max,alpha,n_process], [slicer_info,open_slicer_button,close_slicer_button], concurrency_limit=511)
            close_slicer_button.click(close_slice, [], [slicer_info,open_slicer_button,close_slicer_button], concurrency_limit=511)
            open_denoise_button.click(open_denoise, [denoise_input_dir,denoise_output_dir], [denoise_info,open_denoise_button,close_denoise_button], concurrency_limit=511)
            close_denoise_button.click(close_denoise, [], [denoise_info,open_denoise_button,close_denoise_button], concurrency_limit=511)
        ...
        with gr.TabItem(i18n("1-GPT-SoVITS-TTS")):
            ...
            button1a_open.click(open1a, [inp_text,inp_wav_dir,exp_name,gpu_numbers1a,bert_pretrained_dir], [info1a,button1a_open,button1a_close], concurrency_limit=511)
            button1a_close.click(close1a, [], [info1a,button1a_open,button1a_close], concurrency_limit=511)
            button1b_open.click(open1b, [inp_text,inp_wav_dir,exp_name,gpu_numbers1Ba,cnhubert_base_dir], [info1b,button1b_open,button1b_close], concurrency_limit=511)
            button1b_close.click(close1b, [], [info1b,button1b_open,button1b_close], concurrency_limit=511)
            button1c_open.click(open1c, [inp_text,exp_name,gpu_numbers1c,pretrained_s2G], [info1c,button1c_open,button1c_close], concurrency_limit=511)
            button1c_close.click(close1c, [], [info1c,button1c_open,button1c_close], concurrency_limit=511)
            button1abc_open.click(open1abc, [inp_text,inp_wav_dir,exp_name,gpu_numbers1a,gpu_numbers1Ba,gpu_numbers1c,bert_pretrained_dir,cnhubert_base_dir,pretrained_s2G], [info1abc,button1abc_open,button1abc_close], concurrency_limit=511)
            button1abc_close.click(close1abc, [], [info1abc,button1abc_open,button1abc_close], concurrency_limit=511)
            ...
            button1Ba_open.click(open1Ba, [batch_size,total_epoch,exp_name,text_low_lr_rate,if_save_latest,if_save_every_weights,save_every_epoch,gpu_numbers1Ba,pretrained_s2G,pretrained_s2D], [info1Ba,button1Ba_open,button1Ba_close], concurrency_limit=511)
            button1Ba_close.click(close1Ba, [], [info1Ba,button1Ba_open,button1Ba_close], concurrency_limit=511)
            button1Bb_open.click(open1Bb, [batch_size1Bb,total_epoch1Bb,exp_name,if_dpo,if_save_latest1Bb,if_save_every_weights1Bb,save_every_epoch1Bb,gpu_numbers1Bb,pretrained_s1],   [info1Bb,button1Bb_open,button1Bb_close], concurrency_limit=511)
            button1Bb_close.click(close1Bb, [], [info1Bb,button1Bb_open,button1Bb_close], concurrency_limit=511)
            with gr.TabItem(i18n("1C-推理")):
                ...
                with gr.Row():
                    ...
                    refresh_button.click(fn=change_choices,inputs=[],outputs=[SoVITS_dropdown,GPT_dropdown], concurrency_limit=511)
                with gr.Row():
